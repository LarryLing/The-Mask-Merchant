...
public class QueenMaskInfoPanel : MonoBehaviour
{
    ...
    public QueenCharacter queenCharacter;
    ...
    public void ConfirmSelection()
    {
        ...
        {
            queenCharacter.SwitchToMasked();
            resultBox.ShowResult(queenCharacter.successMessage);
        }
        else
        {
            resultBox.ShowResult(queenCharacter.failureMessage);
        }
